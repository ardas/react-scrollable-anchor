...
var Manager = function Manager() {
  ...
  this.getScrollTimeout = function () {
    return _this.config.handleScrollTimeout;
  };
  ...
  this.handleScroll = function () {
    ...
    var _config = _this.config,
        ...
        offsetShift = _config.offsetShift,
        keepLastAnchorHash = _config.keepLastAnchorHash; // add offsetShift /ardas

    var bestAnchorId = (0, _scroll.getBestAnchorGivenScrollLocation)(_this.anchors, offset + offsetShift); // add offsetShift /ardas
  ...
  this.goToSection = function (id) {
    //ardas
    if (_this.startHashChange) {
      _this.startHashChange = false;
    } else {
      _this.click = true;
    }
    //
  ...
  this.scrollHandler = (0, _func.debounce)(this.handleScroll, this.getScrollTimeout);
